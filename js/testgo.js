const pro_fac = function (){
    ...
    document.addEventListener('click',(e)=>{
     if(e.target == item_1_1_1 || e.target == item_1_1_2){
        item_1_1.style =`display:block`;ov_bg.classList.remove('ov-bg-display');
     }else{
        item_1_1.style =`display:none`;ov_bg.classList.add('ov-bg-display');
     }
     if(e.target == item_1_2_1 || e.target == item_1_2_2){
      item_1_2.style =`display:block`;ov_bg.classList.remove('ov-bg-display');
     }else{
      item_1_2.style =`display:none`;ov_bg.classList.add('ov-bg-display');
     }
  ...
  const pro_ee = function (){
    ...
    document.addEventListener('click',(e)=>{
      if(e.target == item_4_1_1 || e.target == item_4_1_2 || e.target == item_4_1_3 || e.target == item_4_1_4){
        item_4_1.style =`display:block`;ov_bg.classList.remove('ov-bg-display');
      }else{
        item_4_1.style =`display:none`;ov_bg.classList.add('ov-bg-display');
      }
